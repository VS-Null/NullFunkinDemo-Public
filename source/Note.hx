...
class Note extends FlxSprite
{
	...
	public var mechanicNote:Bool = false;
	...
	@:isVar
	private var shouldMove(get, never):Bool = false;

	function get_shouldMove()
	{
		final songsArr = ['Song1', 'Song2', 'Song3', 'Song4']; // song names are placeholders
		for (i in 0...songsArr.length)
		{
			return PlayState.SONG.song.toLowerCase() == songsArr[i].toLowerCase();
		}
		return false;
	}
