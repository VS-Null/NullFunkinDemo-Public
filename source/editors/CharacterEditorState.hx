...
class CharacterEditorState extends MusicBeatState
{
	...
	override function update(elapsed:Float)
	{
		...
		{
			if (FlxG.keys.justPressed.ESCAPE #if (mobileC || mobileCweb) || virtualPad.buttonC.justPressed #end)
			{
				if (goToPlayState)
				{
			...
			if (FlxG.keys.justPressed.R #if (mobileC || mobileCweb) || FlxG.save.data.mobileControls && virtualPad.buttonZ.justPressed #end)
			{
				FlxG.camera.zoom = 1;
			}

			if (FlxG.keys.pressed.E #if (mobileC || mobileCweb) || FlxG.save.data.mobileControls && virtualPad.buttonX.pressed #end && FlxG.camera.zoom < 3)
			{
				FlxG.camera.zoom += elapsed * FlxG.camera.zoom;
				if (FlxG.camera.zoom > 3)
					FlxG.camera.zoom = 3;
			}
			if (FlxG.keys.pressed.Q #if (mobileC || mobileCweb) || FlxG.save.data.mobileControls && virtualPad.buttonY.pressed #end && FlxG.camera.zoom > 0.1)
			{
				FlxG.camera.zoom -= elapsed * FlxG.camera.zoom;
			...
			{
				if (FlxG.keys.justPressed.W #if (mobileC || mobileCweb) || FlxG.save.data.mobileControls && virtualPad.buttonV.justPressed #end)
				{
					curAnim -= 1;
				}

				if (FlxG.keys.justPressed.S #if (mobileC || mobileCweb) || FlxG.save.data.mobileControls && virtualPad.buttonD.justPressed #end)
				{
					curAnim += 1;
				}
				...
				if (FlxG.keys.justPressed.S #if (mobileC || mobileCweb) || FlxG.save.data.mobileControls && virtualPad.buttonD.justPressed #end
					|| FlxG.keys.justPressed.W #if (mobileC || mobileCweb) || FlxG.save.data.mobileControls && virtualPad.buttonV.justPressed #end
					|| FlxG.keys.justPressed.SPACE)
				{
					char.playAnim(char.animationsArray[curAnim].anim, true);
					genBoyOffsets();
				}
				if (FlxG.keys.justPressed.T #if (mobileC || mobileCweb) || FlxG.save.data.mobileControls && virtualPad.buttonA.justPressed #end)
				{
				...
				var controlArray:Array<Bool> = [
					 FlxG.keys.justPressed.LEFT  #if (mobileC || mobileCweb) || FlxG.save.data.mobileControls && virtualPad.buttonLeft.justPressed #end,
					FlxG.keys.justPressed.RIGHT #if (mobileC || mobileCweb) || FlxG.save.data.mobileControls && virtualPad.buttonRight.justPressed #end,
					   FlxG.keys.justPressed.UP    #if (mobileC || mobileCweb) || FlxG.save.data.mobileControls && virtualPad.buttonUp.justPressed #end,
					 FlxG.keys.justPressed.DOWN  #if (mobileC || mobileCweb) || FlxG.save.data.mobileControls && virtualPad.buttonDown.justPressed #end
				];
				...
				for (i in 0...controlArray.length)
				{
					if (controlArray[i])
					{
						var holdShift = FlxG.keys.pressed.SHIFT #if (mobileC || mobileCweb) || FlxG.save.data.mobileControls && virtualPad.buttonB.pressed #end;
						var multiplier = 1;
						if (holdShift)
							multiplier = 10;
