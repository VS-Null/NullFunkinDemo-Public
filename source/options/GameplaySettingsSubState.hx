...
class GameplaySettingsSubState extends BaseOptionsMenu
{
	public function new()
	{
		...
		var option:Option = new Option('Mobile Controls', 'Check this if you have touch system and want to play with Mobile Controls.', 'mobileControls',
			'bool', true);
		addOption(option);
		...
		var option:Option = new Option('Controller Mode', 'Check this if you want to play with\na controller instead of using your Keyboard.',
			'controllerMode', 'bool', #if (mobileC || mobileCweb) true #else false #end);
		addOption(option);
		...
		var option:Option = new Option('Disable Mechanics', "Disables the mods mechanics, also qualifies you as a pussy.", 'mechanics', 'bool', false);
		addOption(option);
