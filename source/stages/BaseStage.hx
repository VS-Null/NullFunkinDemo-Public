...
class BaseStage extends FlxBasic
{
	...
	function startCountdown()
		(onPlayState) ? return PlayState.instance.startCountdown() : return false;

	function endSong()
		(onPlayState) ? return PlayState.instance.endSong() : return false;
	...
	inline private function get_boyfriend():Boyfriend
